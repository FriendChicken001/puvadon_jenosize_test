...
// in puvadon_jenosize/test/configs/mock/mock_data.dart.
...
// Project imports:
import 'package:puvadon_jenosize/src/core/secure_storage_core.dart' as _i11;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockNavigation extends _i1.Mock implements _i10.Navigation {
  @override
  void push<T>(String? path, {T? arguments}) => super.noSuchMethod(
    Invocation.method(#push, [path], {#arguments: arguments}),
    returnValueForMissingStub: null,
  );
  ...
  @override
  void replaceAll<T>(String? path, {T? arguments}) => super.noSuchMethod(
    Invocation.method(#replaceAll, [path], {#arguments: arguments}),
    returnValueForMissingStub: null,
  );

  @override
  void replace<T>(String? path, {T? arguments}) => super.noSuchMethod(
    Invocation.method(#replace, [path], {#arguments: arguments}),
    returnValueForMissingStub: null,
  );

  @override
  void popUntilPath(String? path) => super.noSuchMethod(
    Invocation.method(#popUntilPath, [path]),
    returnValueForMissingStub: null,
  );
...
class MockSecureStorageImpl extends _i1.Mock implements _i11.SecureStorageImpl {
  ...
  @override
  _i8.Future<bool> containsKey({required String? key}) =>
      (super.noSuchMethod(
